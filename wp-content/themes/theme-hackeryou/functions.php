...
function theme_setup() {
	...
	*  sizes with add_image_size. */
	...
	set_post_thumbnail_size(450, 270, true);
	add_image_size('square', 150, 150, true);
	add_image_size('portfolioImage', 450, 270, true);
	add_image_size('full', 900, 540, true);
...
function hackeryou_scripts() {
  ...
  wp_enqueue_script(
    ...
    wp_enqueue_script(
    'iceIce-plugin', //handle
    get_template_directory_uri() . '/js/iceIce-plugin.js', //source
    false, //dependencies
    null, // version number
    true //load in footer
  );
